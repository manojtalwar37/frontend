const Profile =() =>{
    ...
    <div className="row bg-white mt-3   ">
        ...
        <div className="col-3"><img src="assets/images/pic.svg"></img></div>
    
        <div className="col-7">
    
        <span className="">Hello,Manoj</span>
    ...
    <div className="col-3">
        <span className=""><i class="fa-solid fa-file-import"></i></span>
    </div>
    
    <div className="col-7 ">
    
    <span className="fw-bold text-secondary">MY ORDERS</span>
    ...
    <div className="col-3">
    <span className=""><i class="fa-solid fa-user"></i></span>
    </div>
    <div className="col-7 ">
